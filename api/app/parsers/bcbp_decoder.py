...
from app.parsers.utils import decode_bcbp, is_valid_bcbp
        ...
        for page_number, page in enumerate(pdf.pages, start=1):
            ...
            for data in decoded_list:
                if is_valid_bcbp(data):
                    logger.debug("BCBP barcode found on page %d (200 DPI)", page_number)
                    return data
            ...
            for data in decoded_list:
                if is_valid_bcbp(data):
                    logger.debug("BCBP barcode found on page %d (300 DPI)", page_number)
                    return data
    return ""
